    ...
    public partial class fRoom : Form
    {
        ...
        private void ChangeText(DataGridViewRow row)
        {
            ...
            else
            {
                ...
                comboBoxRoomType.SelectedItem = row.Cells["colIdRoomType"].Value.ToString();
        ...
        private Room GetRoomNow()
        {
            ...
            room.IdRoomType = ((DataTable)comboBoxRoomType.DataSource).Rows[index]["id"].ToString();
        ...
        {
            return
                GetIDAutomaticDAO.Instance.Actomatic_ID("Room", "ID");
        }
        #endregion
