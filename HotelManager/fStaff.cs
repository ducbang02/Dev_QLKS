    ...
    public partial class fStaff : Form
    {
        ...
        private void ChangeText(DataGridViewRow row)
        {
            ...
            else
            {
                ...
                comboBoxStaffType.SelectedItem = row.Cells [ colIDStaffType.Name ].Value as string;
                ...
                staff.IdStaffType = row.Cells [ colIDStaffType.Name ].Value.ToString();
        ...
        private Account GetStaffNow()
        {
            ...
            string IDStaffType = GetAutomaticID();
            comboBoxStaffType.SelectedItem = IDStaffType;
            account.IdStaffType = ( ( DataTable )comboBoxStaffType.DataSource ).Rows [ index ] [ "id" ].ToString();
        ...
        {
            return GetIDAutomaticDAO.Instance.Actomatic_ID("StaffType", "ID");
        }
